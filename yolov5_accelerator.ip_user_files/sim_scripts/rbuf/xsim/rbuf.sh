...
#
# Script generated by Vivado on Wed Apr 08 22:02:54 +0800 2026
...
#
# Usage        : rbuf.sh
#                rbuf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rbuf.sh [-reset_run]
#                rbuf.sh [-reset_log]
#                rbuf.sh [-help]
#
...
# script info
echo -e "rbuf.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rbuf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rbuf xil_defaultlib.rbuf xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rbuf -key {Behavioral:sim_1:Functional:rbuf} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/program_files_d/vivado2024/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rbuf.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rbuf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rbuf.sh [-help]\n\
Usage: rbuf.sh [-step]\n\
Usage: rbuf.sh [-lib_map_path]\n\
Usage: rbuf.sh [-reset_run]\n\
Usage: rbuf.sh [-reset_log]\n\
Usage: rbuf.sh [-keep_index]\n\
Usage: rbuf.sh [-noclean_files]\n\n\
