...
#
# Script generated by Vivado on Sun Mar 22 19:55:17 +0800 2026
...
#
# Usage        : wbuf.sh
#                wbuf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                wbuf.sh [-reset_run]
#                wbuf.sh [-reset_log]
#                wbuf.sh [-help]
#
...
# script info
echo -e "wbuf.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./wbuf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wbuf xil_defaultlib.wbuf xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim wbuf -key {Behavioral:sim_1:Functional:wbuf} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb wbuf.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./wbuf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: wbuf.sh [-help]\n\
Usage: wbuf.sh [-step]\n\
Usage: wbuf.sh [-lib_map_path]\n\
Usage: wbuf.sh [-reset_run]\n\
Usage: wbuf.sh [-reset_log]\n\
Usage: wbuf.sh [-keep_index]\n\
Usage: wbuf.sh [-noclean_files]\n\n\
