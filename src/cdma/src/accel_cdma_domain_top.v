...
module accel_cdma_domain_top #(
    // 全局硬件参数
    parameter BANK_NUM            = 8,
    parameter REGION_W            = 8,   // 权重区域深度 2^8 = 256
    ...
    // ==========================================
    // 1. 权重 CDMA (Weight Domain) 接口 [cite: 263-269]
    // ==========================================
    input  wire                               w_start,
    output wire                               w_done,
    ...
    // ==========================================
    // 2. 特征图 CDMA (Feature Domain) 接口 [cite: 270-276]
    // ==========================================
    input  wire                               f_start,
